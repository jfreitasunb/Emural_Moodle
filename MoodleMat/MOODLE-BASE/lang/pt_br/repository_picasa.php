...
/**
 * Strings for component 'repository_picasa', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['oauthinfo'] = '<p>Para usar o repositório do Picasa você precisa estar registrado no Google. Instruções para registrar sua instalação com o Google são descritas em  <a href="{$a->docsurl}">Moodle Docs</a>. A url de redirecionamento deve apontar para :</p><p>{$a->callbackurl}</p>';
