...
/**
 * Strings for component 'table', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   table
...
$string['downloadoptions'] = 'Selecione opções de download';
$string['downloadtsv'] = 'Arquivo texto com valores separados por tabs';
$string['downloadxhtml'] = 'Documento XHTML não paginado';
