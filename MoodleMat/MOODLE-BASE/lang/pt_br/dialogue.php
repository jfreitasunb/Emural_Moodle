...
/**
 * Strings for component 'dialogue', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   dialogue
...
$string['dialogueupgradehelper'] = 'Ajuda para atualização de Diálogo';
...
$string['upgradecheck'] = 'Atualizar diálogo {$a}?';
$string['upgradedcount'] = '{$a} diálogos atualizados';
$string['upgradeiscompleted'] = 'Atualização completa';
$string['upgrademessage'] = 'Este diálogo precisa ser atualizado! Por favor, contate o administrador do Moodle';
$string['upgradenodialoguesselected'] = 'Não há diálogos selecionados';
$string['upgradenoneedupgrade'] = '{$a} diálogos precisam ser atualizados';
$string['upgradereport'] = 'Lista de diálogos ainda não atualizados';
$string['upgradereportdescription'] = 'Isto irá mostrar um relatório de todos os diálogos no sistema que ainda precisam ser atualizados';
$string['upgradeselected'] = 'Atualizar diálogos selecionados';
$string['upgradeselectedcount'] = 'Atualizar {$a} diálogos selecionados?';
$string['upgradingresultfailed'] = 'Resultado: falha de atualização';
$string['upgradingresultsuccess'] = 'Resultado: atualização bem sucedida';
$string['upgradingsummary'] = 'Atualizando diálogo: {$a}';
