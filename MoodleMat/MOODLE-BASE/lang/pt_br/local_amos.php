...
/**
 * Strings for component 'local_amos', language 'pt_br', branch 'MOODLE_24_STABLE'
 *
 * @package   local_amos
...
$string['emailacceptsubject'] = '[contribuição no AMOS] Aceita';
$string['emailcontributionsubject'] = '[contribuição no AMOS] Nova tradução enviada';
$string['emailrejectsubject'] = '[contribuição no AMOS] Rejeitada';
