...
/**
 * Strings for component 'condition', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   condition
...
$string['completionconditionsection_help'] = 'Esta configuração determina quais condições precisam ser satisfeitas para que um aluno possa acessar o tópico. Note que o monitoramento de conclusão precisa estar configurado antes que uma condição de conclusão de atividade possa ser configurada.

Múltiplas condições de conclusão podem ser configuradas, se desejado. Neste caso, o acesso ao tópico será permitido somente quando TODAS as condições forem satisfeitas.';
