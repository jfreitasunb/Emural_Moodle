...
/**
 * Strings for component 'groupselect', language 'pt_br', branch 'MOODLE_21_STABLE'
 *
 * @package   groupselect
...
$string['targetgrouping'] = 'Selecionar grupo de agrupamentos';
