...
/**
 * Strings for component 'attendance', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   attendance
...
$string['sessionenddate'] = 'Data de término da sessão';
...
$string['sessionsgenerated'] = 'Sessões geradas com sucesso';
