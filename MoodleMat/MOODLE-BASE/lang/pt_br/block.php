...
/**
 * Strings for component 'block', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   block
...
$string['addtodock'] = 'Mover isto para a dock';
...
$string['createdat_help'] = 'O local original onde o bloco foi criado. Blocos podem ser configurados para aparecerem em outros locais (contextos) dentro do local original. Por exemplo, um bloco criado em uma página de curso pode ser exibida em atividades dentro desse curso. Um bloco criado na primeira página pode ser exibido em todo o site.';
...
$string['deleteblockcheck'] = 'Tem certeza de que você deseja apagar este bloco intitulado {$a}?';
$string['deleteblockwarning'] = '<p> Você está prestes a apagar um bloco que aparece em outro lugar. </p><p> Local do bloco original: {$a->location} <br /> Bloco configurado para ser exibido em: {$a->pagetype} </p><p> Tem certeza de que quer continuar? </p>';
$string['deletecheck'] = 'Apagar o bloco {$a}?';
$string['dockblock'] = 'Colocar o bloco {$a} em doc';
$string['hideblock'] = 'Ocultar bloco {$a}';
$string['hidedockpanel'] = 'Esconder o painel dock';
...
$string['moveblockhere'] = 'Mover o bloco para cá';
...
$string['showonfrontpageandsubs'] = 'Exibir na página inicial e em quaisquer páginas incluídas nela';
$string['showonfrontpageonly'] = 'Exibir apenas na página inicial';
$string['subpages'] = 'Selecionar páginas';
$string['thisspecificpage'] = 'Esta página específica';
$string['undockall'] = 'Remover todos do dock';
$string['undockblock'] = 'Retirar bloco {$a} do dock';
$string['undockitem'] = 'Remover este item do dock';
