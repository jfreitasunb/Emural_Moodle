...
/**
 * Strings for component 'message_airnotifier', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['errorretrievingkey'] = 'Um erro ocorreu ao tentar obter a chave. O seu site do moodle precisa estar registrado com o Moodle.org para usar este serviço. Talvez você precise registrar novamente para atualizar as sua configurações lá.';
$string['keyretrievedsuccessfully'] = 'Chave recuperada com sucesso';
$string['nodevices'] = 'Não há dispositivos registrados. Os dispositivos serão automaticamente registrados após você permitir que o app Moodle iOS possa receber notificações push';
$string['nopermissiontomanagedevices'] = 'Você não tem permissão para gerenciar dispositivos';
$string['notconfigured'] = 'O servidor Airnotifier não foi configurado para que as mensagens Airnotifier não possam ser enviadas';
$string['pluginname'] = 'Notificações móveis';
$string['requestaccesskey'] = 'Requisitar chave de acesso';
$string['showhide'] = 'Habilitar/desabilitar o dispositivo.';
$string['sitemustberegistered'] = 'Para utilizar a instância pública Airnotifier você deve registrar seu site com o Moodle.org';
