...
/**
 * Strings for component 'theme_brick', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   theme_brick
...
$string['logodesc'] = 'Alterar o logotipo deste tema, digitando o URL para um novo (ou seja, http://www.somesite/animage.png). Como referência, o logotipo padrão é 265px de largura por 60px de alta. Um PNG transparente irá funcionar melhor.';
...
$string['maincolorlinkdesc'] = 'Cor do link para a barra de menu e títulos de imprensa.';
