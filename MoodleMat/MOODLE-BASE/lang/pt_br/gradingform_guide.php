...
/**
 * Strings for component 'gradingform_guide', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['alwaysshowdefinition'] = 'Mostrar definição do guia para alunos';
...
$string['descriptionstudents'] = 'Descrição para alunos';
...
$string['err_nodescription'] = 'Descrição do aluno não pode ficar vazia';
...
$string['hidestudentdesc'] = 'Ocultar descrição da descrição do aluno';
$string['maxscore'] = 'Nota máxima';
$string['name'] = 'Nome';
$string['needregrademessage'] = 'As definições do guia de avaliação foram alteradas depois que o aluno ser avaliado. O aluno não pode ver seu guia de avaliação até que ela seja verificada e a nota atualizada.';
$string['pluginname'] = 'Guia de avaliação';
$string['previewmarkingguide'] = 'Guia de avaliação anterior';
$string['regrademessage1'] = 'Você está prestes a salvar alterações em um guia de avaliação que já foi utilizado para avaliação. Por favor indique se as avaliações existentes precisam ser revisadas. Se você marcar essa opção o guia de avaliação será ocultado para os alunos até que sejam atualizados.';
$string['regrademessage5'] = 'Você está prestes a salvar alterações significativas em um guia que já foi utilizado para avaliação. O valor no livro de notas permanecerá inalterado mas o guia de avaliação será ocultada dos alunos até que seus itens sejam reavaliados.';
...
$string['showmarkspercriterionstudents'] = 'Mostrar avaliação por critérios aos alunos';
