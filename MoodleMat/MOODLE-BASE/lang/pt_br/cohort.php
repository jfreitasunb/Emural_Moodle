...
/**
 * Strings for component 'cohort', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   cohort
...
$string['cohort:assign'] = 'Designar membros do coorte';
$string['cohort:manage'] = 'Gerenciar coortes';
$string['cohorts'] = 'Coortes';
$string['cohortsin'] = '{$a}: coortes disponíveis';
$string['cohort:view'] = 'Usar coortes e ver membros';
...
$string['event_cohort_created'] = 'Coorte criado';
$string['event_cohort_deleted'] = 'Coorte excluido';
$string['event_cohort_member_added'] = 'Usuário adicionado ao coorte';
$string['event_cohort_member_removed'] = 'Usuário removido do coorte';
$string['event_cohort_updated'] = 'Coorte atualizado';
