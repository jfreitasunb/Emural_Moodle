...
/**
 * Strings for component 'backup', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   backup
...
$string['skipmodifprevhelp'] = 'Escolha se quer ou não ignorar cursos que não tenham sido modificados desde o backup anterior';
