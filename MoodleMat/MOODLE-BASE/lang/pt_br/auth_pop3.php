...
/**
 * Strings for component 'auth_pop3', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   auth_pop3
...
$string['auth_pop3description'] = 'Este método usa um servidor POP3 para verificar se o usuário e a senha informados são válidos.';
