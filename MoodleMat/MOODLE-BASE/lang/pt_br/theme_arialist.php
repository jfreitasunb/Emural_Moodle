...
/**
 * Strings for component 'theme_arialist', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['regionwidthdesc'] = 'Isto define a largura das duas regiões de bloco que formam as colunas da esquerda e da direita.';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'A tagline curta para ser exibido sob o nome do site na primeira página. <br /> <em>(Não será exibido com o logotipo).</em>';
