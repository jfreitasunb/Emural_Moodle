...
/**
 * Strings for component 'portfolio_googledocs', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['oauthinfo'] = '<p>Para usar o portfólio do google docs você precisa estar registrado no Google. Instruções sobre o registro de sua instalação com o Google estão descritas no <a href="{$a->docsurl}">Moodle Docs</a>. A Url de redirecionamento precisa apontar para:</p><p>{$a->callbackurl}</p>';
