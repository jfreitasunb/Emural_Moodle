...
/**
 * Strings for component 'theme_essential', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['backgroundstylefixed'] = 'Fixo';
$string['backgroundstylestretch'] = 'Estendido';
$string['backgroundstyletiled'] = 'Lado a lado';
$string['backtotop'] = 'Ir para o topo';
$string['badgepreferences'] = 'Preferências para os badges';
$string['blogpreferences'] = 'Preferências para os blogs';
$string['bootstrapcdn'] = 'FontAwsome a partir do DCN';
$string['bootstrapcdndesc'] = 'Se habilitada, esta irá carregar FontAwesome da fonte CDN Bootstrap online. Ative isso se você está tendo problemas recebendo os ícones com fontes impressionantes em seu site.';
...
$string['donate_desc'] = 'Por favor';
$string['donate_desc2'] = 'para manter o desenvolvimento do tema Essential ou, simplesmente, para demonstrar sua gratidão.';
$string['donate_title'] = 'Doações para o tema Essential';
...
$string['flattr_click'] = 'doe via Flattr';
...
$string['fonttypestandard'] = 'Fontes padronizadas';
...
$string['frontpageblocks'] = 'Alinhamento dos blocos na página inicial';
...
$string['generalheadingdesc'] = 'Defina as configurações globais para o tema aqui. Você vai encontrar as opções de layout e visuais aqui.';
...
$string['instagram'] = 'URL do Instagran';
...
$string['linkedin'] = 'URL do seu Linkedin';
...
$string['paypal_click'] = 'doar através do PayPal';
$string['paypal_desc'] = '{$a->url} ou';
...
$string['pinterest'] = 'URL do seu Pintrest';
...
$string['readme_desc'] = 'Por favor {$a->rl} contendo maiores informações sobre o tema Essential.';
...
$string['region-home-left'] = 'Home (Esquerda)';
$string['region-home-middle'] = 'Home (Centro)';
$string['region-home-right'] = 'Home (Direita)';
...
$string['twitter'] = 'URL do seu Twitter';
...
$string['usecategoryicon'] = 'Ative os ícones de categoria';
$string['usecategoryicondesc'] = 'Use ícones personalizados para as categorias';
...
$string['vk'] = 'URL do seu Vkontakte';
...
$string['youtube'] = 'URL do seu YouTube';
