...
/**
 * Strings for component 'survey', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   survey
...
$string['modulename_help'] = 'O módulo de atividade pesquisa fornece uma série de instrumentos de inquérito validados que têm sido úteis para aferir e estimular a aprendizagem em ambientes on-line. Um professor pode usá-los para recolher dados dos seus alunos que irão ajudá-los a aprender a sua turma e reflectir sobre o seu próprio ensino. Note que estas ferramentas de pesquisa são pré-preenchida com perguntas. Os professores que desejam criar o seu próprio inquérito deve usar o módulo atividade feedback.';
