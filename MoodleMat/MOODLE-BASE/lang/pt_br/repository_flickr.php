...
/**
 * Strings for component 'repository_flickr', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['callbackurl'] = 'URL do Callback';
$string['callbackurltext'] = '<ol>
<li>Visite <a href="http://www.flickr.com/services/api/keys/">Chaves da API do Flickr</a> novamente.</li>
<li>Certifique-se de  configurar a URL de callback para essa chave do Flickr como <strong>{$a}</strong></li></ol>';
