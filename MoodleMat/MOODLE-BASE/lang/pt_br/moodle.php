...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['clamlostandactinglikevirus'] = 'Além disso, o Moodle está configurado para tratar os arquivos como vírus quando o Clam falhar. Isto significa basicamente que ninguém conseguirá fazer uploads enquanto o problema não for resolvido.';
...
$string['commentsrequirelogin'] = 'Você precisa fazer o login para ver os comentários';
...
$string['duplicateconfirm'] = 'Tem certeza de que quer duplicar {$a->modtype} \'{$a->modname}\' ?';
$string['duplicatecontcourse'] = 'Voltar para o curso';
...
$string['emaildigest_help'] = 'Este é o cenário diário digest fóruns que vai usar por padrão. * No resumo - você receberá um e-mail por post no fórum, * Digest - mensagens completas - você receberá um resumo de e-mail por dia contendo o conteúdo completo de cada post no fórum, * Digest - apenas temas - você receberá um digerir e-mail por dia contendo apenas o assunto de cada post no fórum. Você também pode escolher uma configuração diferente para cada fórum, se você quiser.';
...
$string['emailresetconfirmation'] = 'Oi {$a->firstname}, uma redefinição de senha foi solicitada para a sua conta \'{$a->username}\' em {$a->sitename}. Para confirmar este pedido e definir uma nova senha para sua conta, por favor, vá para o seguinte endereço web: {$a->link} (Este link é válido por {$a->resetminutes} minutos a partir do momento que esta redefinição foi solicitada) Se esta redefinição de senha não foi solicitada por você, nenhuma ação é necessária. Se precisar de ajuda, entre em contato com o administrador do site, {$a->admin}';
...
$string['frontpagedescriptionhelp'] = 'Esta descrição pode ser mostrada na página principal utilizando o bloco descrição de curso/site ou incluindo uma seção de tópicos na página inicial.';
...
$string['idnumbergrouping_help'] = 'O número ID de um agrupamento é somente usado para buscar o grupo em sistemas externos e não é exibido em nenhum lugar no site. Se o grupo tem um nome código oficial ele pode ser digitado. Caso contrário o campo pode ser deixado em branco.';
...
$string['interestslist_help'] = 'Inserir a sua lista separada por vírgulas';
...
$string['invalidusername'] = 'A identificação de usuário pode conter somente caracteres alfanuméricos minúsculos, sublinhado (_), hífen (-), ponto (.) ou arroba (@)';
...
$string['lastsiteaccess'] = 'Última acesso ao site';
...
<ol>
<li>Preencha o <a href="{$a}">Formulário de Cadastramento</a> com os seus detalhes.</li>
...
$string['myhome'] = 'Minha página inicial';
...
$string['notifyloginfailuresmessageend'] = 'Você pode consultar estes logs em {$a}/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors.';
...
$string['resortbyfullname'] = 'Pelo nome completo';
$string['resortbyidnumber'] = 'Por número id';
$string['resortbyshortname'] = 'Por Nome Breve';
$string['resortcourses'] = 'Ordenar cursos';
$string['resortsubcategoriesbyidnumber'] = 'Ordenar categorias pelo idnumber';
$string['resortsubcategoriesbyname'] = 'ordenar categorias pelo nome';
...
$string['rsskeyshelp'] = 'Para garantir segurança e privacidade, as URLs dos RSS feeds contêm um token que identifica a qual usuário pertencem. Isto previne que outros usuários acessem, via RSS feed, áreas do Moodle que eles não deveriam acessar.</p><p>
Este token é criado automaticamente na primeira vez que você acessa uma área do Moodle que produz RSS feeds. Se você achar que token de RSS feeed foi comprometido de alguma maneira você pode requisitar um novo clicando  no link Resetar. Por favor, note que suas URL atuais para RSS feeds se tornarão inválidas.';
...
$string['sortcategoriesbyidnumber'] = 'Ordenar categorias pelo número ID';
$string['sortcategoriesbyname'] = 'Ordenar categorias pelo nome';
$string['sortcoursesbyfullname'] = 'Ordenar cursos pelo nome';
$string['sortcoursesbyidnumber'] = 'Ordenar cursos pelo número ID';
$string['sortcoursesbyshortname'] = 'Ordenar cursos pelo nome breve';
...
$string['startdate_help'] = 'Esta configuração determina o início da primeira semana para um curso em formato semanal. Também determina a data inicial em que os logs das atividades do curso estarão disponíveis.';
...
$string['usercurrentsettings'] = 'Minhas configurações de perfil';
...
$string['userviewingsettings'] = 'Configurações do perfil para {$a}';
