...
/**
 * Strings for component 'report_customsql', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['daily'] = 'Agendado, diariamente';
$string['dailynote'] = 'Estas consultas são executadas diariamente, quando você clicar no link para ver os resultados.';
$string['dailyqueries'] = 'Consultas diárias';
...
$string['deletethiscategory'] = 'Apagar esta categoria';
...
$string['selectcategory'] = 'Selecione a categoria para este relatório';
