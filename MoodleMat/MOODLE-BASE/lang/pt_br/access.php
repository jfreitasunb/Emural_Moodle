...
/**
 * Strings for component 'access', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   access
...
$string['accesshelp'] = 'Ajuda para Acessibilidade';
...
$string['skipnavigation'] = 'Pular para a navegação';
$string['skipto'] = 'Saltar para {$a}';
