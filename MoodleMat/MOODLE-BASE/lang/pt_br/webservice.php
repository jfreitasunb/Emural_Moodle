...
/**
 * Strings for component 'webservice', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   webservice
...
$string['event_webservice_function_called'] = 'Função do Web service chamada';
$string['event_webservice_login_failed'] = 'Login do web service falhou';
$string['event_webservice_service_created'] = 'Web service criado';
$string['event_webservice_service_updated'] = 'Web service atualizado';
$string['event_webservice_service_user_added'] = 'Web service adicionado a usuário';
...
$string['webservices'] = 'Serviços da Web';
