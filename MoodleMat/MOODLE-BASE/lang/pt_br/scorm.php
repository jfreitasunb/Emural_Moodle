...
/**
 * Strings for component 'scorm', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   scorm
...
$string['attemptstatusall'] = 'Início e página de entrada';
$string['attemptstatusentry'] = 'Página de entrada apenas';
$string['attemptstatusmy'] = 'Início apenas';
