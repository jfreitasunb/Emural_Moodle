...
/**
 * Strings for component 'group', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   group
...
$string['event_group_member_added'] = 'Membro adcionado ao grupo';
$string['event_group_member_removed'] = 'Membro removido do grupo';
...
$string['groupby'] = 'Automáticamente criar com base em';
