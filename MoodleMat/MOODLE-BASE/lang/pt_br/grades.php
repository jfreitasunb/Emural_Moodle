...
/**
 * Strings for component 'grades', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   grades
...
$string['aggregatesubcats_help'] = 'Esta configuração determina se notas em subcategorias são incluídas na agregação.';
...
$string['aggregationposition_help'] = 'Esta opção define se as colunas da categoria do curso e total do cursoã so mostradas no começo ou no fim dos relatórios do livro de notas.';
...
$string['gradesonly'] = 'Apenas notas';
