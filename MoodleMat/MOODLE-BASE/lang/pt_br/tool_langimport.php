...
/**
 * Strings for component 'tool_langimport', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['remotelangnotavailable'] = 'Moodle não consegue acessar download.moodle.org. Não é possível fazer a atualização automática. Como alternativa, baixe os arquivos zip em http://download.moodle.org , copie-os no diretório {$a} e descompacte-os manualmente.';
$string['uninstall'] = 'Desinstalar pacote de idioma selecionado';
$string['uninstallconfirm'] = 'Você está prestes a desinstalar completamente o idioma {$a}, você tem certeza?';
