...
/**
 * Strings for component 'filters', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   filters
...
$string['courserole'] = 'Papel no curso';
...
$string['neveraccessed'] = 'Nunca acessado';
$string['nevermodified'] = 'Nunca modificado';
$string['newfilter'] = 'Novo filtro';
$string['nofiltersenabled'] = 'Nenhum plugin de filtro foi habilitado neste site.';
$string['off'] = 'Desabilitado';
$string['offbutavailable'] = 'Desabilitado, mas disponível';
$string['on'] = 'Habilitado';
