...
/**
 * Strings for component 'plugin', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
 * @package   plugin
...
$string['filtercontribonly'] = 'Mostrar apenas complementos';
$string['filtercontribonlyactive'] = 'Mostrando apenas complementos';
...
$string['pluginchecknotice'] = 'Essa página mostra os plugins que podem requerer sua atenção durante a atualização. Itens destacados incluem novos plugins que serão instalados, plugins com novas versões que serão atualizados e plugins que estão faltando. Plugins de terceiros (contrib) também são destacados.
É recomendado que você verifique estão disponíveis versões mais novas dos plugins de terceiros e atualize seus códigos-fonte antes de continuar com essa atualização do Moodle.';
...
$string['source'] = 'Fonte';
$string['sourceext'] = 'Contribuições';
