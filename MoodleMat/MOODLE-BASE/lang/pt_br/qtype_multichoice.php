...
/**
 * Strings for component 'qtype_multichoice', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['pluginnameadding'] = 'Adicionando uma pergunta de múltipla escolha';
$string['pluginnameediting'] = 'Editando uma questão de múltipla escolha';
$string['pluginname_help'] = 'Em resposta a uma pergunta (que pode incluir uma imagem), o entrevistado escolhe respostas múltiplas. Existem dois tipos de questões de múltipla escolha - uma resposta e múltiplas respostas.';
