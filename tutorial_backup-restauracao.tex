...
\begin{enumerate}[\bf 1)]
	\item Ap\'os entrar na sua disciplina, clique no menu ``Administra\c{c}\~ao'' que aparece na lateral direita. Caso o menu n\~ao esteja aparecendo clique no {\'\i}cone de engrenagem que dever\'a estar no lado esquerdo. Procure e clique na op\c{c}\~ao ``Backup''.
	\begin{figure}[H]
    	\centering
...
\begin{enumerate}[\bf 1)]
	\item Ap\'os entrar na sua disciplina, clique no {\'\i}cone de \textbf{engrenagem}, ou procure o menu ``\textbf{Administra\c{c}\~ao}'', ambos na lateral direita da tela. Clique na opção ``\textbf{Restaurar}''
	\begin{figure}[H]
    	\centering
	...
	\item Na pr\'oxima tela procure o campo ``Restaura neste curso'' e marque a op\c{c}\~ao ``Excluir o conte\'udo deste curso e restaurar o backup''. Ap\'os isso clique no bot\~ao ``CONTINUAR''.
	\begin{figure}[H]
    	\centering
